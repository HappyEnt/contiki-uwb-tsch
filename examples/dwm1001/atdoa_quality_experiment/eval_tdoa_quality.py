...
def read_line(identifier, line):
    ...
    if line.startswith("TD"):
        if identifier in identifier_mac_addr_mapping:
            ...
            if not (anchor_1_mac, anchor_2_mac) in distance_measurements[our_mac]:
                distance_measurements[our_mac][(anchor_1_mac, anchor_2_mac)] = []

            distance_measurements[our_mac][(anchor_1_mac, anchor_2_mac)].append((current_distance, measurement))
